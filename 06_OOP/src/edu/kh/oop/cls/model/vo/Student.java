...
// 접근제한자 public : 같은 프로젝트 내에서, 어떤 클래스에서든 import 할 수 있음을 나타냄
	...
	// == 멤버변수 : 메서드 밖에 작성된 변수
	//		1) 클래스 변수(== static 변수): 필드에 static 예약어가 작성된 변수(객체 생성 안해도 쓸 수 있음)
	//		2) 인스턴스 변수 : 필드에 작성되는 일반 변수(객체 미생성시 사용 불가)
	//		
	...
	protected int v2 = 20;
	int v3 = 30;
	private int v4 = 40; // 특별한 경우 아니면 private 사용하자
	...
	// 아래는 getter / setter = private 메서드의 외부 접근할때만 사용한다.
	
	public String getName() {
		return name;
	}
	
	public void setName(String name) { // /*매개변수*/ [자료형][변수명]의 형식,정수형이면 [int][4]
		this.name = name;			 // std1.setName()에서 
	}								// 받아옴 = String name = String 값
